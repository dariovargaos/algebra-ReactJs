...
export {default as MultiplePropsComponent } from './MultiplePropsComponent';
export {default as MultiplePropsClassComponent } from './MultiplePropsClassComponent';

//zadaci sa tecaja ispod
